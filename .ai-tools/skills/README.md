# AI Capability System (Skills)

Enterprise-tested capabilities that auto-activate based on file context, prompt keywords, and intent patterns.

---

## What Are Capabilities?

Capabilities are modular knowledge bases that AI assistants load contextually. They provide:
- Domain-specific engineering guidelines
...
**Solution:** This framework includes the hooks + configuration to make them activate.
...
**Purpose:** Creating and managing AI assistant skills
...
```bash
cp -r .ai-tools/skills/backend-dev-guidelines \
      your-project/.ai-tools/skills/
```
...
```bash
cp .ai-tools/skills/skill-rules.json \
   your-project/.ai-tools/skills/
```
...
**Check:**
1. Is skill directory in `.ai-tools/skills/`?
...
```bash
# Check skill exists
ls -la .ai-tools/skills/

# Validate skill-rules.json
cat .ai-tools/skills/skill-rules.json | jq .

# Check hooks are executable
ls -la .ai-tools/hooks/*.sh

# Test hook manually
./.ai-tools/hooks/skill-activation-prompt.sh
```
...
**Questions?** See [AI_INTEGRATION_GUIDE.md](../../AI_INTEGRATION_GUIDE.md) for comprehensive integration instructions.
