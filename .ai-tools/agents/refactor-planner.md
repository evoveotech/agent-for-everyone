...
- **Propose solutions** that align with the project's existing patterns and conventions (check PROJECT_GUIDE.md)
...
Remember to check for any project-specific guidelines in PROJECT_GUIDE.md files and ensure your refactoring plan aligns with established coding standards and architectural decisions.
