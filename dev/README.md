...
An enterprise methodology for maintaining project state, decisions, and progress across AI-assisted engineering sessions.
...
**After a reset, the AI assistant must rediscover everything.**
...
**These files survive context resets** - the AI assistant reads them to resume work immediately.
...
### ✅ COMPLETED
- Database schema created (Customer, Order, Inventory, Payment models)
- OrderController implemented with BaseController pattern
- Sentry integration working

### 🟡 IN PROGRESS
- Creating OrderService with business logic
...
- Handles HTTP requests for order lifecycle
- Delegates to OrderService

**src/services/orderService.ts** (IN PROGRESS)
- Business logic for order processing
- Next: Add inventory validation and caching

## Quick Resume
To continue:
1. Read this file
2. Continue implementing OrderService.processFulfillment()
...
- [x] Create database schema (Customer, Order, Inventory, Payment)
- [x] Set up controllers with BaseController pattern
- [x] Configure Sentry observability

## Phase 2: Implementation 🟡 IN PROGRESS
- [x] Create OrderController
- [ ] Create OrderService (IN PROGRESS)
...
- [ ] Manual API testing for fulfillment endpoints
```
...
2. **The AI assistant creates the three files:**
...
1. **The AI assistant reads all three files**
